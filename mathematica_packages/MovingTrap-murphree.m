...
printMovingTrapParameters[{{minx_,miny_,minz_},{omegax_,omegay_,omegaz_},bmin_}]:=Print[
"Position = "<>ToString[{minx,miny,minz}*10^6]<>" \[Mu]m\n"<>
"Frequency = "<>ToString[{omegax,omegay,omegaz}]<>" Hz\n"<>
"Bmin = "<>ToString[bmin]<>" G"];


printMovingTrapParameters::usage=
"printTrapParameters[{{minx_,miny_,minz_},{omegax_,omegay_,omegaz_},bmin_}] prints
human-readable versions of individual elements of the list generated by MovingTrap.";
